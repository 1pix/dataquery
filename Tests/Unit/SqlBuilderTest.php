 ...
 */
abstract class SqlBuilderTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	/** @var \Tesseract\Dataquery\Parser\QueryParser */
	protected $sqlParser;
	...
	public function setUp() {
		...
		/** @var $dataQueryWrapper \Tesseract\Dataquery\Component\DataProvider */
		$dataQueryWrapper = GeneralUtility::makeInstance(
			'Tesseract\\Dataquery\\Component\\DataProvider'
		);
		/** @var $controller \Tesseract\Displaycontroller\Controller\DisplayController */
		$controller = GeneralUtility::makeInstance(
			'Tesseract\\Displaycontroller\\Controller\\DisplayController'
		);
	...
	public function selectQueryWithFulltextFilter($filter, $index, $fulltextCondition) {
		/** @var \Tesseract\Dataquery\Parser\FulltextParser $fulltextParser */
		$fulltextParser = GeneralUtility::makeInstance(
			'Tesseract\\Dataquery\\Parser\\FulltextParser'
		);
		/** @var \Tesseract\Dataquery\Utility\DatabaseAnalyser $databaseAnalyser */
		$databaseAnalyser = GeneralUtility::makeInstance(
			'Tesseract\\Dataquery\\Utility\\DatabaseAnalyser'
		);
